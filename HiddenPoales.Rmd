...
plotMKmodel(pp.polymorphic12b.6, rate.cat = 2, color = "col.blind" )
dev.off()
...
cols <- c(
  # Base colors
  "#FF0000", "#0000FF", "#008000", "#FFA500", "#800080", "#FFFF00", # red, blue, green, orange, purple, yellow
  
  # Darker versions
  "#8B0000", "#00008B", "#006400", "#FF8C00", "#4B0082", "#9B870C", # darkred, darkblue, darkgreen, darkorange, darkpurple, darkyellow
  
  # Lighter versions
  "#FF6666", "#6666FF", "#66FF66", "#FFD580", "#D299D2", "#FFFF99"  # lightred, lightblue, lightgreen, lightorange, lightpurple, lightyellow
)
