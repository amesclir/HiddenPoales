...
pp.polymorphic12a.5<-corHMM(mytree,trait12[,c(1,2,3)],rate.cat=3, model = "SYM", node.states="marginal")
pp.polymorphic12a.5

LegendAndRate.ind <- getStateMat4Dat(trait12[,c(1,2,3)]) 
LegendAndRate.ind
Rate.ind <- LegendAndRate.ind$rate.mat
Rate.ind
Rate.ind <- equateStateMatPars(Rate.ind, c(1,6))
Rate.ind
Rate.ind <- equateStateMatPars(Rate.ind, c(1,3))
Rate.ind
Rate.ind <- equateStateMatPars(Rate.ind, c(1,4))
Rate.ind
Rate.ind <- equateStateMatPars(Rate.ind, c(1,2))
Rate.ind
RateClassMat <- getRateCatMat(3)
RateClassMat
StateMats <- list(Rate.ind, Rate.ind, Rate.ind)
StateMats
IND3 <- getFullMat(StateMats, RateClassMat)
IND3

Rate.indsym <- Rate.ind
Rate.indsym
Rate.indsym <- equateStateMatPars(Rate.indsym, c(2,4))
Rate.indsym
Rate.indsym <- equateStateMatPars(Rate.indsym, c(1,2))
Rate.indsym
StateMats <- list(Rate.indsym, Rate.indsym, Rate.indsym)
StateMats
IND3sym <- getFullMat(StateMats, RateClassMat)
IND3sym

pp.polymorphic12a.6<-corHMM(mytree,trait12[,c(1,2,3)],rate.cat=3, rate.mat = IND3, node.states="marginal")
pp.polymorphic12a.6

pp.polymorphic12a.7<-corHMM(mytree,trait12[,c(1,2,3)],rate.cat=3, rate.mat = IND3sym, node.states="marginal")
pp.polymorphic12a.7
...
RateMat.ind <- RateMat
RateMat.ind
RateMat.ind <- equateStateMatPars(RateMat.ind, c(1,9))
RateMat.ind
RateMat.ind <- equateStateMatPars(RateMat.ind, c(1,8))
RateMat.ind
RateMat.ind <- equateStateMatPars(RateMat.ind, c(1,3,5))
RateMat.ind
RateMat.ind <- equateStateMatPars(RateMat.ind, c(1,5))
RateMat.ind
RateMat.ind <- equateStateMatPars(RateMat.ind, c(1,5))
RateMat.ind
RateMat.ind <- equateStateMatPars(RateMat.ind, c(1,2,3))
RateMat.ind

RateClassMat <- getRateCatMat(3)
RateClassMat
StateMats3.ind <- list(RateMat.ind, RateMat.ind, RateMat.ind)
StateMats3.ind
FullMat3.ind <- getFullMat(StateMats3.ind, RateClassMat)
FullMat3.ind

RateMat.indsym <- RateMat.ind
RateMat.indsym
RateMat.indsym <- equateStateMatPars(RateMat.indsym, c(1,4))
RateMat.indsym
RateMat.indsym <- equateStateMatPars(RateMat.indsym, c(1,3))
RateMat.indsym
RateMat.indsym <- equateStateMatPars(RateMat.indsym, c(1,2))
RateMat.indsym
RateClassMat <- getRateCatMat(3)
RateClassMat
StateMats3.indsym <- list(RateMat.indsym, RateMat.indsym, RateMat.indsym)
StateMats3.indsym
FullMat3.indsym <- getFullMat(StateMats3.indsym, RateClassMat)
FullMat3.indsym

pp.polymorphic12b.7<-corHMM(mytree,trait12[,c(1,2,4)],rate.cat=3,rate.mat = FullMat3.ind, node.states="marginal")
pp.polymorphic12b.7

pp.polymorphic12b.8<-corHMM(mytree,trait12[,c(1,2,4)],rate.cat=3,rate.mat = FullMat3.indsym, node.states="marginal")
pp.polymorphic12b.8

RateMatsym
StateMatssym3 <- list(RateMatsym, RateMatsym, RateMatsym)
StateMatssym3
FullMatsym3 <- getFullMat(StateMatssym3, RateClassMat)
FullMatsym3
pp.polymorphic12b.9<-corHMM(mytree,trait12[,c(1,2,4)],rate.cat=3,rate.mat = FullMatsym3, node.states="marginal")
pp.polymorphic12b.9
...
pp.polymorphic12c.3
pp.polymorphic12c.4<-corHMM(mytree,trait12[,c(1,2)],rate.cat=3,node.states="marginal")
pp.polymorphic12c.4
pp.polymorphic12c.5<-corHMM(mytree,trait12[,c(1,2)],rate.cat=3,model = "SYM", node.states="marginal")
pp.polymorphic12c.5
...
pp.polymorphic12d.3
pp.polymorphic12d.4<-corHMM(mytree,trait12[,c(1,3)],rate.cat=3,node.states="marginal")
pp.polymorphic12d.4
pp.polymorphic12d.5<-corHMM(mytree,trait12[,c(1,3)],rate.cat=3,model = "SYM",node.states="marginal")
pp.polymorphic12d.5
...
cols <- c("pink", "pink", "brown", "brown", "pink", "pink", "brown", "brown","pink", "pink", "brown", "brown")
...
cols <- c("green", "blue", "green", "blue", "green", "blue","green", "blue","green", "blue","green", "blue")
...
pp.polymorphic13a.5<-corHMM(mytree,trait13[,c(1,2,3)],rate.cat=3,model = "SYM", node.states="marginal")
pp.polymorphic13a.5

pp.polymorphic13a.6<-corHMM(mytree,trait13[,c(1,2,3)],rate.cat=3, rate.mat = IND3, node.states="marginal")
pp.polymorphic13a.6

pp.polymorphic13a.7<-corHMM(mytree,trait13[,c(1,2,3)],rate.cat=3, rate.mat = IND3sym, node.states="marginal")
pp.polymorphic13a.7
...
pp.polymorphic13b.5<-corHMM(mytree,trait13[,c(1,2,4)],rate.cat=3,model="SYM", node.states="marginal")
pp.polymorphic13b.5

pp.polymorphic13b.6<-corHMM(mytree,trait13[,c(1,2,4)],rate.cat=3, rate.mat = IND3, node.states="marginal")
pp.polymorphic13b.6

pp.polymorphic13b.7<-corHMM(mytree,trait13[,c(1,2,4)],rate.cat=3, rate.mat = IND3sym, node.states="marginal")
pp.polymorphic13b.7
...
pp.polymorphic13c.5<-corHMM(mytree,trait13[,c(1,2,5)],rate.cat=3,model="SYM", node.states="marginal")
pp.polymorphic13c.5

pp.polymorphic13c.6<-corHMM(mytree,trait13[,c(1,2,5)],rate.cat=3, rate.mat = IND3, node.states="marginal")
pp.polymorphic13c.6

pp.polymorphic13c.7<-corHMM(mytree,trait13[,c(1,2,5)],rate.cat=3, rate.mat = IND3sym, node.states="marginal")
pp.polymorphic13c.7
...
pp.polymorphic13d.5<-corHMM(mytree,trait13[,c(1,2,6)],rate.cat=3,model="SYM",node.states="marginal")
pp.polymorphic13d.5

pp.polymorphic13d.6<-corHMM(mytree,trait13[,c(1,2,6)],rate.cat=3, rate.mat = IND3, node.states="marginal")
pp.polymorphic13d.6

pp.polymorphic13d.7<-corHMM(mytree,trait13[,c(1,2,6)],rate.cat=3, rate.mat = IND3sym, node.states="marginal")
pp.polymorphic13d.7

######################
#INDIVIDUAL ANALYSES
#open close
pp.polymorphic13f<-corHMM(mytree,trait13[,c(1,2)],rate.cat=2,node.states="marginal")
pp.polymorphic13f
pp.polymorphic13f.1<-corHMM(mytree,trait13[,c(1,2)],rate.cat=1,node.states="marginal")
pp.polymorphic13f.1
pp.polymorphic13f.2<-corHMM(mytree,trait13[,c(1,2)],rate.cat=2, model = "SYM", node.states="marginal")
pp.polymorphic13f.2
pp.polymorphic13f.3<-corHMM(mytree,trait13[,c(1,2)],rate.cat=1,model = "SYM", node.states="marginal")
pp.polymorphic13f.3
pp.polymorphic13f.4<-corHMM(mytree,trait13[,c(1,2)],rate.cat=3,node.states="marginal")
pp.polymorphic13f.4
pp.polymorphic13f.5<-corHMM(mytree,trait13[,c(1,2)],rate.cat=3,model = "SYM", node.states="marginal")
pp.polymorphic13f.5

#wind animal
pp.polymorphic13g<-corHMM(mytree,trait13[,c(1,3)],rate.cat=2,node.states="marginal")
pp.polymorphic13g
pp.polymorphic13g.1<-corHMM(mytree,trait13[,c(1,3)],rate.cat=1,node.states="marginal")
pp.polymorphic13g.1
pp.polymorphic13g.2<-corHMM(mytree,trait13[,c(1,3)],rate.cat=2, model = "SYM", node.states="marginal")
pp.polymorphic13g.2
pp.polymorphic13g.3<-corHMM(mytree,trait13[,c(1,3)],rate.cat=1,model = "SYM", node.states="marginal")
pp.polymorphic13g.3
pp.polymorphic13g.4<-corHMM(mytree,trait13[,c(1,3)],rate.cat=3,node.states="marginal")
pp.polymorphic13g.4
pp.polymorphic13g.5<-corHMM(mytree,trait13[,c(1,3)],rate.cat=3,model = "SYM", node.states="marginal")
pp.polymorphic13g.5
##########################################
...
pdf(file=pdffn, width=8, height=8)
plotMKmodel(pp.polymorphic13a.5, rate.cat = 3, color = "col.blind" )
dev.off()
...
tiplabels(pie=to.matrix(trait[mytree$tip.label],
    levels(as.factor(trait))),piecol=cols,cex=0.1)
nodelabels(node=1:mytree$Nnode+Ntip(mytree),
    pie=pp.polymorphic13a.5$states,piecol=cols,cex=0.1)
add.simmap.legend(colors=cols,prompt=FALSE,x=0.9*par()$usr[1],
    y=0.8*par()$usr[3],fsize=2)
dev.off()
...
pdf(file=pdffn, width=8, height=8)
plotMKmodel(pp.polymorphic13b.6, rate.cat = 3, color = "col.blind" )
dev.off()
...
tiplabels(pie=to.matrix(trait[mytree$tip.label],
    levels(as.factor(trait))),piecol=cols,cex=0.1)
nodelabels(node=1:mytree$Nnode+Ntip(mytree),
    pie=pp.polymorphic13b.6$states,piecol=cols,cex=0.1)
add.simmap.legend(colors=cols,prompt=FALSE,x=0.9*par()$usr[1],
    y=0.8*par()$usr[3],fsize=2)
dev.off()
...
pdf(file=pdffn, width=8, height=8)
plotMKmodel(pp.polymorphic13c.6, rate.cat = 3, color = "col.blind" )
dev.off()
...
tiplabels(pie=to.matrix(trait[mytree$tip.label],
    levels(as.factor(trait))),piecol=cols,cex=0.1)
nodelabels(node=1:mytree$Nnode+Ntip(mytree),
    pie=pp.polymorphic13c.6$states,piecol=cols,cex=0.1)
add.simmap.legend(colors=cols,prompt=FALSE,x=0.9*par()$usr[1],
    y=0.8*par()$usr[3],fsize=2)
dev.off()
...
pdf(file=pdffn, width=8, height=8)
plotMKmodel(pp.polymorphic13d.4, rate.cat = 3, color = "col.blind" )
dev.off()
...
tiplabels(pie=to.matrix(trait[mytree$tip.label],
    levels(as.factor(trait))),piecol=cols,cex=0.1)
nodelabels(node=1:mytree$Nnode+Ntip(mytree),
    pie=pp.polymorphic13d.4$states,piecol=cols,cex=0.1)
add.simmap.legend(colors=cols,prompt=FALSE,x=0.9*par()$usr[1],
    y=0.8*par()$usr[3],fsize=2)
dev.off()
